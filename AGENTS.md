...
### 8. Prioritization – nothing about choosing the highest-leverage tasks first

### 9. Feedback from reality – users, metrics, experiments (not just tests/logs)

### 10. Timeboxing / speed – you can still overthink forever

### 11. Learning from others – no mention of reading, studying, or copying proven patterns

### 12. Product thinking – value > elegance

### xi137. Goal clarity – no guidance on what to build or why (only how)
